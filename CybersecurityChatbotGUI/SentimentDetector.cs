...
namespace CybersecurityChatbotGUI
{
    ...
    class SentimentDetector
    {
        ...
        public SentimentDetector()
        {
            ...
            {
                "worried", "scared", "afraid", "anxious", "nervous", "unsafe", "frightened", "concerned", "panic"
            };

            _triggerWords[Sentiment.Curious] = new List<string>
            {
                "curious", "wondering", "interested", "want to know", "how does", "what is", "explain", "learn"
            };

            _triggerWords[Sentiment.Frustrated] = new List<string>
            {
                "frustrated", "annoyed", "confused", "dont understand", "hate", "difficult", "complicated", "angry"
            };

            _triggerWords[Sentiment.Happy] = new List<string>
            {
                "great", "thanks", "helpful", "awesome", "love it", "amazing", "fantastic", "happy"
            };
        }
        ...
        {
            if (sentiment == Sentiment.Worried)
            {
